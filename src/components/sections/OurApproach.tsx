...
export function OurApproach() {
  ...
  return (
    <div className="flex-shrink-0 w-screen h-full flex flex-col items-center justify-center max-md:w-full max-md:min-h-screen max-md:items-stretch max-md:px-8 max-md:py-24">
      <div className="mx-auto">
        ...
        <FadeInView delay={0.5} className="mt-8">
          <p className="font-heading text-xl md:text-2xl font-semibold text-text-primary">
            ...
            <span className="text-accent-indigo">useful experience</span>.
          </p>
        </FadeInView>
      </div>
    </div>
