...
class ImageTrailVariant7 {
  ...
  private resetIdleTimer() {
    ...
    this.idleTimer = setTimeout(() => this.fadeOutAll(), 3000);
  }
...
export default function ImageTrail({
  ...
  return (
    <div
      className="relative z-[1] h-full w-full overflow-hidden rounded-lg bg-transparent"
      ref={containerRef}
    >
      {items.map((url, i) => (
        <div
        ...
        >
          <div
            className="content__img-inner absolute top-[-10px] left-[-10px] h-[calc(100%+20px)] w-[calc(100%+20px)] bg-center bg-cover"
